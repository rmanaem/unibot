...
from Data.Courses.utils import extractFromPdf
...
if __name__ == '__main__':
    ...
    for courseName in courseNames:
        Lectures = os.path.join(ROOT_DIR, 'Data', 'Courses', courseName, 'Lectures')
        ...
        for filepath in filepaths:
            with open(filepath, mode='rb') as f:
                ...
                folder = glob.glob(
                    os.path.join(ROOT_DIR, 'Data', 'Courses', courseName, 'Lectures', 'OtherMaterial', 'Images',
                                 Path(filepath).stem, '*'))
                for image in folder:
                ...
                folder = glob.glob(
                    os.path.join(ROOT_DIR, 'Data', 'Courses', courseName, 'Lectures', 'OtherMaterial', 'Videos',
                                 Path(filepath).stem, '*'))
                for video in folder:
        ...
        lectures_pathname = os.path.join(Lectures, courseName + '-Lectures.ttl')
